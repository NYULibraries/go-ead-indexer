...
QUERY_PARAMS[30]='pf=unittitle_teim%5E145.0+parent_unittitles_teim+collection_teim+unitid_teim%5E60+collection_unitid_teim%5E40+language_ssm+unitdate_start_teim+unitdate_end_teim+unitdate_teim+name_teim+subject_teim%5E60.0+abstract_teim%5E55.0+creator_teim%5E60.0+scopecontent_teim%5E60.0+bioghist_teim%5E55.0+title_teim+material_type_teim+place_teim+dao_teim+chronlist_teim+appraisal_teim+custodhist_teim%5E15+acqinfo_teim%5E20.0+address_teim+note_teim%5E30.0+phystech_teim%5E30.0+author_teim%5E10.0'
QUERY_PARAMS[35]='ps=50'
QUERY_PARAMS[36]='qf=unittitle_teim%5E145.0+parent_unittitles_teim+collection_teim+unitid_teim%5E60+collection_unitid_teim%5E40+language_ssm+unitdate_start_teim+unitdate_end_teim+unitdate_teim+name_teim+subject_teim%5E60.0+abstract_teim%5E55.0+creator_teim%5E60.0+scopecontent_teim%5E60.0+bioghist_teim%5E55.0+title_teim+material_type_teim+place_teim+dao_teim+chronlist_teim+appraisal_teim+custodhist_teim%5E15+acqinfo_teim%5E20.0+address_teim+note_teim%5E30.0+phystech_teim%5E30.0+author_teim%5E10.0'
