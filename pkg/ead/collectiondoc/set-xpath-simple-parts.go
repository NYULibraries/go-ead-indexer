...
func (collectionDoc *CollectionDoc) setXPathSimpleParts(node types.Node) error {
	...
	parts.Abstract.Values, parts.Abstract.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.Abstract.Source, node)
	if err != nil {
		return err
	}

	parts.AcqInfo.Source = "//archdesc[@level='collection']/acqinfo/p"
	parts.AcqInfo.Values, parts.AcqInfo.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.AcqInfo.Source, node)
	if err != nil {
		return err
	}
	...
	parts.Author.Values, parts.Author.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.Author.Source, node)
	if err != nil {
		return err
	}
	...
	parts.CorpNameNotInDSC.Values, parts.CorpNameNotInDSC.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.CorpNameNotInDSC.Source, node)
	if err != nil {
		return err
	}
	...
	parts.CustodHist.Values, parts.CustodHist.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.CustodHist.Source, node)
	if err != nil {
		return err
	}

	parts.DAO.Source = "//dao"
	parts.DAO.Values, parts.DAO.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.DAO.Source, node)
	if err != nil {
		return err
	}
	...
	parts.FamNameNotInDSC.Values, parts.FamNameNotInDSC.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.FamNameNotInDSC.Source, node)
	if err != nil {
		return err
	}
	...
	parts.GenreFormNotInDSC.Values, parts.GenreFormNotInDSC.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.GenreFormNotInDSC.Source, node)
	if err != nil {
		return err
	}
	...
	parts.GeogNameNotInDSC.Values, parts.GeogNameNotInDSC.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.GeogNameNotInDSC.Source, node)
	if err != nil {
		return err
	}
	...
	parts.NameNotInDSC.Values, parts.NameNotInDSC.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.NameNotInDSC.Source, node)
	if err != nil {
		return err
	}

	parts.NoteNotInDSC.Source = "//archdesc[@level='collection']/*[name() != 'dsc']//note"
	parts.NoteNotInDSC.Values, parts.NoteNotInDSC.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.NoteNotInDSC.Source, node)
	if err != nil {
		return err
	}

	parts.OccupationNotInDSC.Source = "//archdesc[@level='collection']/*[name() != 'dsc']//occupation"
	parts.OccupationNotInDSC.Values, parts.OccupationNotInDSC.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.OccupationNotInDSC.Source, node)
	if err != nil {
		return err
	}
	...
	parts.PersNameNotInDSC.Values, parts.PersNameNotInDSC.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.PersNameNotInDSC.Source, node)
	if err != nil {
		return err
	}
	...
	parts.SubjectNotInDSC.Values, parts.SubjectNotInDSC.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.SubjectNotInDSC.Source, node)
	if err != nil {
		return err
	}

	parts.TitleNotInDSC.Source = "//archdesc[@level='collection']/*[name() != 'dsc']//title"
	parts.TitleNotInDSC.Values, parts.TitleNotInDSC.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.TitleNotInDSC.Source, node)
	if err != nil {
		return err
	}
	...
	parts.UnitID.Values, parts.UnitID.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.UnitID.Source, node)
	if err != nil {
		return err
	}

	parts.UnitTitle.Source = "//archdesc[@level='collection']/did/unittitle"
	parts.UnitTitle.Values, parts.UnitTitle.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.UnitTitle.Source, node)
	if err != nil {
		return err
	}
	...
	parts.Collection.Values, parts.Collection.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.Collection.Source, node)
	if err != nil {
		return err
	}
	...
	parts.Heading.Values, parts.Heading.XMLStrings, err = eadutil.GetNodeValuesAndXMLStrings(parts.Heading.Source, node)
	if err != nil {
		return err
	}
